...
import {FaEye, FaRegTrashAlt, FaStar, FaUserCheck} from "react-icons/fa";
...
import CandidateOpportunities from "@/components/CandidateOpportunities";
import CandidateNotifications from "@/components/CandidateNotifications";
...
export default function CandidateDashboard() {
  ...
  const handleOpportunitiesVisibility = () => {
  ...
  const handleApplicationsVisibility = () => {
    setNotificationsVisible(false)
    setSettingsVisible(false);
    setSavedJobsVisible(false);
    setCalendarVisible(false);
        ...
        <section className="max-w-full mx-auto h-full">
          <div className="flex justify-start items-start flex-wrap md:flex-nowrap relative">
              ...
              <div className=" w-full">
                <div className=" w-full px-2 mt-6">
                  ...
                  <div className="flex justify-center items-center px-2 py-1 w-30 rounded-md bg-red-800 ml-[-2px] mb-6">
                    <span className="text-white text-[11px] leading-3 mt-0.5 mb-0.5  font-medium uppercase tracking-widest">CANDIDATE</span>
                  </div>
                ...
                <div className="flex flex-col items-start justify-start gap-2 pt-5">
                  ...
                  <button
                    onClick={handleOpportunitiesVisibility}
                    className={`flex items-center justify-start gap-1 w-full px-0 py-2 rounded-md transition cursor-pointer text-[12px] font-medium duration-700 text-white pl-2  hover:bg-linear-to-br hover:from-sky-800 hover:to-sky-950 ${
                  ...
                  <button
                    onClick={handleApplicationsVisibility}
                    className={`flex items-center justify-start gap-1 w-full px-0 py-2 rounded-md transition cursor-pointer text-[12px] font-medium duration-700 text-white pl-2  hover:bg-linear-to-br hover:from-sky-800 hover:to-sky-950 ${
                      applicationsVisible
                        ? "bg-linear-to-br from-sky-800 to-sky-950"
                        : ""
            ...
            <div className="flex flex-col items-start justify-start gap-4 mx-auto  w-full h-full min-h-screen pl-70" >
              <div className=' bg-linear-to-br from-sky-700 to-sky-900 py-4 px-8 w-full'>
                ...
                <h3 className='text-white text-2xl font-bold'>
                  ...
                  {opportunitiesVisible ? "Opportunities" : ""}
                  {applicationsVisible ? "My Applications" : ""}
              ...
              <div className='p-8 w-full'>
                ...
                {notificationsVisible && (
                  <div className="flex flex-col items-start justify-start gap-2  w-full">
                    {user?.uid && <CandidateNotifications candidateUid={user.uid} />}
                  </div>
                )}
