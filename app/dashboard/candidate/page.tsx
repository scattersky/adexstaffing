...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setResumeUrl(response.data.resume_path);
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axios.post(
        "https://adextravelnursing.com/api_upload_resume.php",
        formData,
        { headers: { "Content-Type": "multipart/form-data" } }
      );
      if (res.data.success) {
        setResumeUrl(res.data.file_url);
      }
    } catch (err) {
      console.error(err);
    }
  ...
  return (
    <div>
      <InnerPageTitle title='Dashboard' subHeading='Candidate' />
            ...
            <div className="flex flex-col items-start justify-start gap-4 w-full md:w-[80%]" >
              ...
              {myResumeVisible && (
                <div className="flex flex-col items-start justify-start gap-2 bg-white rounded-lg p-4 shadow-lg w-full">
                  ...
                  <div className="max-w-3xl mx-auto mt-0 mb-6">
                    ...
                    <button
                      ...
                      className="bg-red-700 text-white px-4 py-2 rounded mt-4 text-sm"
                    >
